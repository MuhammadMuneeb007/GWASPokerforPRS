...
if __name__ == "__main__":
    ...
    file = downloadlink[indexer].split("/")[-1]
    #print(savingdirec,file,downloadlink[indexer])

    rename_file_ending_with_digit(savingdirec)  
    poker(savingdirec,file,downloadlink[indexer])


    try:
        gwaspath = savingdirec + os.sep + "gwas.csv"
    ...
    try:
        gwaspath = savingdirec + os.sep + "gwas.csv.modified"
    ...
    with open(savingdirec+os.sep+'transform.txt', 'w') as file:
        for key, value in transformeddic.items():
    ...
    file = savingdirec+os.sep+'transform.txt'
    import pandas as pd
    file_path = file
    try:
    ...
    file_path = savingdirec+os.sep+'Output.py'
    ...
    try:
        with open(savingdirec+os.sep+'transform1.txt', 'r') as file1:
            content = file1.read()
            print(content)
    except FileNotFoundError:
        print("File not found.")
